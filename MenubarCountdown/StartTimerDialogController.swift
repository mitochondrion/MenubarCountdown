...
class StartTimerDialogController: NSWindowController {
    ...
    var timerInterval: TimeInterval {
        ...
        let hours = defaults.integer(forKey: KJUserDefaults.TimerHoursKey);
        let minutes = defaults.integer(forKey: KJUserDefaults.TimerMinutesKey);
        let seconds = defaults.integer(forKey: KJUserDefaults.TimerSecondsKey);
